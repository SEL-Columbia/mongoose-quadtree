...
function save(schema, options) {
    ...
    var createNode = function(nlat, wlng, slat, elng, tree) {
        ...
        //XXX This is required to make sure data is partitoned identically to the way it was done before
        //TODO make work somehow
        QuadtreeModel.findWithin(nlat, wlng, slat, elng).exec(function(err, sites)  {
            if (err) throw (err);
