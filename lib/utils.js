...
module.exports = (function() {
    // Keeping track of connectedModels
    this.models = {}; 

    // Lock to synchronize writes and reads on quadtree 
    this.lock = new rwlock();

    // Added new model to dict
    this.setModel = function(Model, collection) {
        models[collection] = Model; 
    }

    // Create a geoquery function for specified collection 
