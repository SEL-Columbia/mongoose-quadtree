...
function statics(schema, options) {
    ...
    schema.statics.findNodes = function(bounds) {
        ...
        var crossesNode = function(tree, bounds, dir) {
            //                en[0,1]
            //       _________
            //      |         |
            //      |         |
        ...
        var findNodes = function(node, bounds) {
            ...
            Model.findOne({_id: node}).exec(function(err, tree) {
                ...
                if (tree.children.wn && crossesNode(tree, bounds, 'wn')) {
                ...
                if (tree.children.en && crossesNode(tree, bounds, 'en')) {
                ...
                if (tree.children.ws && crossesNode(tree, bounds, 'ws')) {
                ...
                if (tree.children.es && crossesNode(tree, bounds, 'es')) {
